...
def meudiamanhaController():
    ...
    if request.method == 'POST':
        ...
        try:
            codprofessor = request.args.get('codprofessor')  # Obtém o código do professor da query string
            if codprofessor:
                # Filtra os registros pelo código do professor
                data = meudiamanha.query.filter_by(codprofessor=codprofessor).all()
            else:
                # Se não houver código do professor, retorna todos os registros
