...
export default function ListadeMateriaisResponsavel({ navigation, route }) {
    ...
    useEffect(() => {
        api.get(`/api/responsavel/${codigo}/listademateriais`)
            .then((response) => {
...
return (
    <View style={styles.container}>
        ...
        <View style={styles.topBar}>
            ...
            <Text style={styles.topBarTxt}>Lista de Materiais</Text>
        </View>
        ...
        {loading ? (
            ...
            <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>
                    Lista de materiais não cadastrada para a turma {nomeTurma} ainda.
                </Text>
            </View>
        ) : (
            <FlatList
    ...
    <TouchableOpacity onPress={() => toggleAlunoDetails(item)}>
        ...
        >
            <View style={styles.alunoRow}>
                ...
                <Text style={styles.alunoName}>Lista de Materiais da turma {item.nome_turma}</Text>
            </View>
